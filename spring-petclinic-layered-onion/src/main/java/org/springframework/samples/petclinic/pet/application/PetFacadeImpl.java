...
import org.springframework.samples.petclinic.pet.domain.service.PetRepository;
 ...
 */
@Service
class PetFacadeImpl implements PetFacade {

	private final PetRepository petRepository;

	@Autowired
	public PetFacadeImpl(PetRepository petRepository) {
