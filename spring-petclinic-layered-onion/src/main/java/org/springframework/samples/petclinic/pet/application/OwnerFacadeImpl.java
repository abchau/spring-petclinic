...
import org.springframework.samples.petclinic.pet.domain.model.Owner;
import org.springframework.samples.petclinic.pet.domain.model.Owner.PaginatedOwner;
import org.springframework.samples.petclinic.pet.domain.service.OwnerRepository;
 ...
 */
@Service
class OwnerFacadeImpl implements OwnerFacade {

	private final OwnerRepository ownerRepository;

	@Autowired
	public OwnerFacadeImpl(OwnerRepository ownerRepository) {
