...
import org.springframework.samples.petclinic.pet.domain.VisitService;
...
non-sealed class VisitFacadeImpl implements VisitFacade {
	...
	@Autowired
	public VisitFacadeImpl(VisitService visitService) {
		this.visitService = visitService;
	}

	public Visit addVisit(Visit newVisit) {
		return visitService.addVisit(newVisit);
	}

	public List<Visit> findVisits(Integer petId) {
		return visitService.findVisits(petId);
	}
