...
import org.springframework.samples.petclinic.owner.application.OwnerService;
...
class OwnerController {
	...
	public String processFindForm(@RequestParam(defaultValue = "1") int page, @ModelAttribute("form") Owner form,
		...
		Page<Owner> ownersResults = ownerService.findPaginatedForOwnersLastName(page, form.getLastName());
		...
		for (Owner o1: ownersResults) {
System.out.println("ownersResults: " + o1.getPets());
System.out.println("owner: " + o1.getPetNames());
	}
	...
	public ModelAndView showOwner(@PathVariable("id") Integer id) {
		...
		System.out.println("owner: " + owner.getPetNames());
		mav.addObject(owner);
		return mav;
	}
