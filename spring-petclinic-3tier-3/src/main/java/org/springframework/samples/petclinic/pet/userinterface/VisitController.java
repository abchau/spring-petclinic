...
class VisitController {
	...
	public String processNewVisitForm(@PathVariable Integer ownerId, @PathVariable Integer petId, @Valid CreateVisitForm form,
		...
		visit.setDate(LocalDate.parse(form.getDate()));
