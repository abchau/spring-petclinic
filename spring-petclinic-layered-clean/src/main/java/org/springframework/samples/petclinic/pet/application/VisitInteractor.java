...
import org.springframework.samples.petclinic.pet.domain.VisitGateway;

/**
 * @author github.com/abchau
 */
@Service
class VisitInteractor implements VisitBoundary {

	private final VisitGateway visitRepository;

	@Autowired
	public VisitInteractor(VisitGateway visitRepository) {
