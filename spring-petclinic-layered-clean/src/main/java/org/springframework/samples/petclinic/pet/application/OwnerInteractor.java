...
import org.springframework.samples.petclinic.pet.domain.OwnerGateway;
 ...
 */
@Service
class OwnerInteractor implements OwnerBoundary {

	private final OwnerGateway ownerRepository;

	@Autowired
	public OwnerInteractor(OwnerGateway ownerRepository) {
