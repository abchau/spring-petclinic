...
import org.springframework.samples.petclinic.vet.domain.VetGateway;
 ...
 */
@Service
class VetInteractor implements VetBoundary {

	private final VetGateway vetRepository;

	public VetInteractor(VetGateway vetRepository) {
