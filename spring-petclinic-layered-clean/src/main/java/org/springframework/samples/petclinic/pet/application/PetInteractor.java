...
import org.springframework.samples.petclinic.pet.domain.PetGateway;

/**
 * @author github.com/abchau
 */
@Service
class PetInteractor implements PetBoundary {

	private final PetGateway petRepository;

	@Autowired
	public PetInteractor(PetGateway petRepository) {
