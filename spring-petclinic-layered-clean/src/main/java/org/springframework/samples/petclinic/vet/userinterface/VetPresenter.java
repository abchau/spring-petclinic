...
import org.springframework.samples.petclinic.vet.application.VetBoundary;
...
@Controller
 class VetController {
	...
	private final VetBoundary vetBoundary;

	public VetController(VetBoundary vetBoundary) {
		this.vetBoundary = vetBoundary;
	}

	@GetMapping("/vets.html")
	public String showVetList(@RequestParam(defaultValue = "1") int page, Model model) {
		PaginatedVet vets = vetBoundary.findAll(page);
	...
	public @ResponseBody VetXmlView showResourcesVetList() {
		...
		vets.setVets(vetBoundary.findAll());
		return vets;
	}
